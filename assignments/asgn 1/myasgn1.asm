...
# Name:
.data
Name: .string "Megan Robinson" # Your name in double quotes
...
CarryNoOV1:	.word	128  # Replace DDD with a decimal value.
CarryNoOV2:	.word	90  # Replace DDD with a decimal value.
...
SignNoCarry1:	.word	127  # Replace DDD with a decimal value.
SignNoCarry2:	.word	31  # Replace DDD with a decimal value.
...
bitval1:	.word 0x86	# replace the HHHH with your answer in hexadecimal
...
#
#	 0x97CA (ADD/AND/OR/NOT/XOR) CLEARMASK  =  FF7F
...
#
#	0x85CA (ADD/AND/OR/NOT/XOR) SETMASK  =  20

 .eqv SETOP OR	# replace OPERATION with one of (ADD/AND/OR/NOT/XOR).
SETMASK:	.word 0x20	# replace HHHH with hexadecimal VALUE you selected.
...
TESTMASK: .word 0x40	# replace HHHH with hexadecimal VALUE you selected.
